...
ActiveRecord::Schema.define(version: 2021_03_11_105146) do
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.index ["voter_id", "votable_type", "votable_id"], name: "index_votes_on_voter_id_and_votable_type_and_votable_id", unique: true
